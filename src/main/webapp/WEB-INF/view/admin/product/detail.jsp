                ...
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><a href="/admin" target="">Dashboard</a>/
                        	<a href="/admin/product" target="">Products</a>/Detail
                        </li>
                    </ol>
							...
							<div class="col-12 mx-auto">
								...
								<hr/>
							 	<div class="card" style="width: 60%;">
								  <img src="/images/product/${productDetail.image}" style="max-height: auto;" alt="avatar preview" />
								  ...
								  <ul class="list-group list-group-flush">
								    ...
								    <li class="list-group-item">Datail Description: ${productDetail.detailDesc}</li>
